...
# define images and video path
images_n_vids_path = "/mnt/e/OCR/images_vids"
image_path = os.path.join(images_n_vids_path, "pelakir_2.jpg")
video_path = os.path.join(images_n_vids_path, "test_video_short.mp4")

# define detected plate path
savepath = "/mnt/e/OCR/sidebar"
weights = '/mnt/e/OCR/yolov7/weights/best.pt'
device_id = 'cpu'
image_size = 640
trace = True
